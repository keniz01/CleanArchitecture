...
namespace CleanArchitecture.Domain.Tests
{
    ...
    public class ContinentTests
    {
        ...
        {
            Assert.Throws<InputViolationException>(() => _ = new Continent(Guid.NewGuid(), "Edinburgh", default, new Coordinates(55.953251, -3.188267)));
        }

        [Test]
        public void Create_Continent_Should_Throw_InputViolationException_When_Name_Is_Null_Or_Empty()
        {
            Assert.Throws<InputViolationException>(() => _ = new Continent(Guid.NewGuid(), default, 264, new Coordinates(55.953251, -3.188267)));
        }

        [Test]
        public void Create_Continent_Should_Throw_IdViolationException_When_Id_Is_Null_Or_Empty()
        {
            Assert.Throws<InputViolationException>(() => _ = new Continent(default, "Edinburgh", 264, new Coordinates(55.953251, -3.188267)));
        }
        ...
        {
            Assert.DoesNotThrow(() => _ = new Continent(Guid.NewGuid(), "Europe", 12000, new Coordinates(55.953251, -3.188267)));
        }
        
        [Test]
        public void Update_Continent_Should_Add_Or_Update_Region()
        {
            var continent = new Continent(Guid.NewGuid(), "Europe", 100264, new Coordinates(55.953251, -3.188267));

            var regionId = Guid.NewGuid();
            var region = new Region(regionId, "Eastern Europe", 120000, new Coordinates(55.010200, -1.777777));
