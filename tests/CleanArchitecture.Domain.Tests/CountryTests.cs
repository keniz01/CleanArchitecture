...
namespace CleanArchitecture.Domain.Tests
{
    ...
    {
        [Test]
        public void Create_Country_Should_Throw_AreaViolationException_When_Area_Is_Less_Than_0()
        {
            var capitalCity = new CapitalCity(Guid.NewGuid(), "Edinburgh", 264, new Coordinate(55.953251, -3.188267));
            Assert.Throws<AreaViolationException>(() => _ = new Country(Guid.NewGuid(), "Scotland", -1, new Coordinate(55.953251, -3.188267), capitalCity));
        }

        [Test]
        public void Create_Country_Should_Throw_NameViolationException_When_Name_Is_Null_Or_Empty()
        {
            var capitalCity = new CapitalCity(Guid.NewGuid(), "Edinburgh", 264, new Coordinate(55.953251, -3.188267));
            Assert.Throws<NameViolationException>(() => _ = new Country(Guid.NewGuid(), default, 77933, new Coordinate(55.953251, -3.188267), capitalCity));
        }
