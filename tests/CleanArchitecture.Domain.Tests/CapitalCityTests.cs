...
namespace CleanArchitecture.Domain.Tests
{
    ...
    public class CapitalCityTests
    {
        ...
        {
            Assert.Throws<AreaViolationException>(() => _ = new CapitalCity(Guid.NewGuid(), "Edinburgh", -1, new Coordinate(55.953251, -3.188267)));
        }

        [Test]
        public void Create_CapitalCity_Should_Throw_NameViolationException_When_Name_Is_Null_Or_Empty()
        {
            Assert.Throws<NameViolationException>(() => _ = new CapitalCity(Guid.NewGuid(), default, 264, new Coordinate(55.953251, -3.188267)));
        }
