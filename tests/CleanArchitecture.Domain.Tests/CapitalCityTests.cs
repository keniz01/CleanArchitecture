...
namespace CleanArchitecture.Domain.Tests
{
    ...
    public class CapitalCityTests
    {
        ...
        {
            Assert.Throws<InputViolationException>(() => _ = new CapitalCity(Guid.NewGuid(), "Edinburgh", default, new Coordinates(55.953251, -3.188267)));
        }

        [Test]
        public void Create_CapitalCity_Should_Throw_InputViolationException_When_Name_Is_Null_Or_Empty()
        {
            Assert.Throws<InputViolationException>(() => _ = new CapitalCity(Guid.NewGuid(), default, 264, new Coordinates(55.953251, -3.188267)));
        }

        [Test]
        public void Create_CapitalCity_Should_Throw_IdViolationException_When_Id_Is_Null_Or_Empty()
        {
            Assert.Throws<InputViolationException>(() => _ = new CapitalCity(default, "Edinburgh", 264, new Coordinates(55.953251, -3.188267)));
        }
